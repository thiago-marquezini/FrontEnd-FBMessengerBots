<div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                <p>Gostou do nosso sistema? Adiquira um de nossos planos e aproveite todos os recursos!</p>
                <a class="btn purchase-button mt-4 mt-md-0" href="https://www.bootstrapdash.com/product/star-admin-pro/" target="_blank">Ver Planos</a>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Bots Ativos</p>
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0"><? echo count($UserBots); ?></h3>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Mensagens Receb.</p>
                      <div class="fluid-container">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-bookmark-outline mr-1" aria-hidden="true"></i> Receba mais mensagens!
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Resp. Válidas</p>
                      <div class="fluid-container">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-calendar mr-1" aria-hidden="true"></i> Crie boas respostas
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card card-statistics">
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      <p class="mb-0 text-right">Cliques em Links</p>
                      <div class="fluid-container">
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-reload mr-1" aria-hidden="true"></i> Rastreie cliques facilmente
                  </p>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="row d-none d-sm-flex mb-4">
                    <div class="col-4">
                      <h5 class="text-primary">Conversas Iniciadas</h5>
                      <p>34657</p>
                    </div>
                    <div class="col-4">
                      <h5 class="text-primary">Respostas Válidas</h5>
                      <p>45673</p>
                    </div>
                    <div class="col-4">
                      <h5 class="text-primary">Média Diária</h5>
                      <p>45673</p>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="../assets_dash/images/faces/face1.jpg" alt="profile image">
                      </div>
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="../assets_dash/images/faces/face2.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="../assets_dash/images/faces/face3.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
          ...
          <script src="../assets_dash/js/chart.js"></script>